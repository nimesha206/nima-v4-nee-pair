   ...
   if (pairingCode && !XeonBotInc.authState.creds.registered) {
      ...
      if (!!phoneNumber) {
         ...
         if (!Object.keys(PHONENUMBER_MCC).some(v => phoneNumber.startsWith(v))) {
            console.log(chalk.bgBlack(chalk.redBright("Start with country code of your WhatsApp Number, Example : +94726800969")))
            process.exit(0)
         }
      } else {
         phoneNumber = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFor example: +94726800969 : `)))
         phoneNumber = phoneNumber.replace(/[^0-9]/g, '')
...
//------------------------------------------------------
    XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
            await delay(1000 * 10)
            await XeonBotInc.sendMessage(XeonBotInc.user.id, { text: `🪀Support/Contact Developer\n\n\n⎆Donate: https://files.catbox.moe/w9lv7j.jpg\n\n⎆YouTube: https://youtube.com/@nimaedition?si=k-p-6UVUdgz2jsPb\n\n⎆Whatsapp Channel: https://whatsapp.com/channel/0029Vb68g1c3LdQLQDkbAQ3M\n\n⎆Whatsapp Chat: https://wa.me/+94726800969\n\n⎆\n\n⎆\n\n⎆\n\n⎆\n\n⎆\n\n⎆GitHub: https://github.com/nimawpbot\n\n⎆\n\n\n` });
